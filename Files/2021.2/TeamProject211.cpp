...
{
	void TeamProject::Save()
	{
		ofstream OutFile((AString)Path, ios::trunc | ios::beg);

		OutFile << "begin~TeamProject" << "~ID:" << CurrentID << endl;
	...
	Component* TeamProject::GetFromID(unsigned long long ID, int Filter) const
	{
